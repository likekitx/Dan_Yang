// login brower
declare const window: Window & { attachEvent: any,chrome: any,opera: any };
export function GetCurrentBrowser ():any{
...
export function GetOs ():string {
    ...
    let bIsAndroid = (sUserAgent.toLowerCase().match(/android/i)) == null || "android";
    if (isLinux) {
